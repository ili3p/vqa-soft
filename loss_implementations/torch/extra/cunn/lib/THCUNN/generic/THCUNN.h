...
TH_API void THNN_(MultiClassNLLCriterion_updateOutput)(
                  THCState *state,
                  THCTensor *input,
...
TH_API void THNN_(MultiClassNLLCriterion_updateGradInput)(
                  THCState *state,
                  THCTensor *input,
                  THCIndexTensor *target,
                  THCTensor *gradInput,
                  ...
                  THCTensor *total_weight,
                  long ignore_index);
TH_API void THNN_(SoftClassNLLCriterion_updateOutput)(
                  THCState *state,
                  THCTensor *input,
                  THCIndexTensor *target,
                  THCTensor *output,
...
TH_API void THNN_(SoftClassNLLCriterion_updateGradInput)(
                  THCState *state,
                  THCTensor *input,
                  THCIndexTensor *target,
                  THCTensor *gradInput,
